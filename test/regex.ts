...
const evaltesttms_comp0vbzf2: regex.RegexFind<'xszds', 's(z|d){0,2}s'> = ['x', 'szds', '']
const evaltesttms_comp0vbzf2a: regex.RegexFind<'xsds', 's(z|d){0,2}s'> = ['x', 'sds', '']
const evaltesttms_comp0vbzf4: regex.RegexFind<'xszds', 's(z|d){0,2}s$'> = ['x', 'szds', '']
const evaltettms_comp0vbzf4b: regex.RegexFind<'xszds', '^s(z|d){0,2}s'> = []
const evaltesttms_comp0vbzf6: regex.RegexFind<'xszds', 's(z|d){0,2}s'> = ['x', 'szds', '']

const evaltesttms_f_comp0vbzf0: regex.RegexFind<'szds',  '^s(z|d){0,2}s'> = ['', 'szds', '']
const evaltesttms_ff_comp0vbzf0: regex.RegexFind<'szds',  '^s(z|d){0,2}s$'> = ['', 'szds', '']
const evaltesttms_fr_comp0vbzf0: regex.RegexFind<'szdsye9r',  '^s(z|d){0,2}s'> = ['', 'szds', 'ye9r']
const evaltesttms_frb_comp0vbzf0: regex.RegexFind<'szdsye9r',  '^s(z|d){0,2}s$'> = []
const evaltesttms_f_comp0vbzf2: regex.RegexFind<'xszds', '^s(z|d){0,2}s'> = []
const evaltesttms_f_comp0vbzf2a: regex.RegexFind<'xsds', '^s(z|d){0,2}s'> = []
const evaltesttms_f_comp0vbzf4: regex.RegexFind<'xszds', '^s(z|d){0,2}s$'> = []
const evaltesttms_f_comp0vbzf6: regex.RegexFind<'xszds', '^s(z|d){0,2}s'> = []
...
const evaltesttms_comp0vbzfx2:  regex.RegexFind<'xszds', 's[zd\\d]{0,2}s'> = ['x', 'szds', '']
...
const evaltesttms_comp0vbzfx4:  regex.RegexFind<'xszds', 's(z|d){0,2}s$'>  = ['x', 'szds', '']
const evaltesttms_comp0vbzfx4b: regex.RegexFind<'xszds', '^s(z|d){0,2}s'>  = []
const evaltesttms_comp0vbzfx6:  regex.RegexFind<'xszds', 's(z|d){0,2}s'>   = ['x', 'szds', '']
