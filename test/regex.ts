...
const test_mloop1: regex.MatchLoop<'xxxxx', 'xx', 'pattern'>       = [['xxxx', 'x'], '0000000000000010']
const test_mloop1a: regex.MatchLoop<'xxxxx', 'xx', 'pattern', tOne> = [['xx', 'xxx'], vOne]
const test_mloop2: regex.MatchLoop<'xxxxx', 'x', 'char'>           = [['xxxxx', ''], '0000000000000101']
const test_mloop3: regex.MatchLoop<'xxxxxx', 'x', 'char'>          = [['xxxxxx', ''], '0000000000000110']
const test_mloop2a: regex.MatchLoop<'xxxxx', 'x', 'char', Bit.BitInc<tOne>> = [['xx', 'xxx'], '0000000000000010']
const test_mloop3a: regex.MatchLoop<'xxxxxx', 'x', 'char', Bit.BitInc<Bit.BitInc<tOne>>> = [['xxx', 'xxx'], '0000000000000011']
const test_mloop4: regex.MatchLoop<'xxxyxxx', 'x', 'char'>                  = [['xxx', 'yxxx'], '0000000000000011']
const test_mloop5: regex.MatchLoop<'xxxyxxx', 'x', 'char', Bit.BitInc<tOne>> = [['xx', 'xyxxx'], '0000000000000010']
// dot
const dot_test_mloop0: regex.MatchLoop<'xxxxx', 'xx', 'char', tOne>     = [['xx', 'xxx'], vOne]
const dot_test_mloop1: regex.MatchLoop<'xxxxx', 'xx', 'pattern'>       = [['xxxx', 'x'], '0000000000000010']
const dot_test_mloop1a: regex.MatchLoop<'xxxxx', 'xx', 'pattern', tOne> = [['xx', 'xxx'], vOne]
const dot_test_mloop2: regex.MatchLoop<'xxxxx', 'x', 'char'>           = [['xxxxx', ''], '0000000000000101']
const dot_test_mloop3: regex.MatchLoop<'xxxxxx', 'x', 'char'>          = [['xxxxxx', ''], '0000000000000110']
const dot_test_mloop2a: regex.MatchLoop<'xxxxx', 'x', 'char', Bit.BitInc<tOne>> = [['xx', 'xxx'], '0000000000000010']
const dot_test_mloop3a: regex.MatchLoop<'xxxxxx', 'x', 'char', Bit.BitInc<Bit.BitInc<tOne>>> = [['xxx', 'xxx'], '0000000000000011']
const dot_test_mloop4: regex.MatchLoop<'xxxyxxx', 'x', 'char'> = [['xxx', 'yxxx'], '0000000000000011']
const dot_test_mloop5: regex.MatchLoop<'xxxyxxx', 'x', 'char', Bit.BitInc<tOne>> = [['xx', 'xyxxx'], '0000000000000010']
...
const evaltest_comp0yaa: regex.ReadTape<'ssssssss', regex.Comp<'s(ss)+s'>> = ['ssssssss', '']
const evaltest_comp0yaaa: regex.ReadTape<'ssssssss', regex.Comp<'s(ss|x)+s'>> = ['ssssssss', '']
...
const evaltesttms_comp0gxc: regex.ReadTape<'ssssxssss', regex.Comp<'ssss[cx]?s'>> = ['ssssxs', 'sss']
