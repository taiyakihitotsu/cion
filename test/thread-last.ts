...
const maintest_threadl_3: Cion.RawLisp<"(->> 1 (+ 1) (+ 2))"> = ['prim', ['0000000000000100', '0000000000000001']]
const maintest_threadl_4: Cion.RawLisp<"(+ 2 (+ 1 1))"> = ['prim', ['0000000000000100', '0000000000000001']]
