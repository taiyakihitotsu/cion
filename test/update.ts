...
const maintest0_update_1: Cion.RawLisp<'(update [0 1 2] 99 (fn [x] (+ x 99)))'> = ['prim', 'nil'] // ['vec', ['prim', '0000000000000000'], ['prim', '0000000000000001'], ['prim', '0000000000000010']]
...
const maintest_lisp_1: Cion.Lisp<`(update [0 1 2] 99 (fn [x] (+ x 99)))`> = 'nil'
...
const maintest_lisp_5: Cion.Lisp<`(update {:a 1 :b 2} 1 (fn [x] (+ x 99)))`> =  'nil'
const maintest_lisp_: Cion.Lisp<`(update {:a 1 :b 2} 1 inc)`> = 'nil'
