...
const sub_test_f0 : Cion.Lisp<`(- 1 0)`> = '1'
const sub_test_f1 : Cion.Lisp<`(- 1 nil)`>['ast']['error'] = 'LispSubError1'
const sub_est_f2 : Cion.Lisp<`(- 1 true)`>['ast']['error'] = 'LispSubError0'
const sub_test_f3 : Cion.Lisp<`(- 1 'string')`>['ast']['error'] = 'LispSubError1'
const sub_test_f4 : Cion.Lisp<`(- 1 sub)`>['ast']['error'] = 'LispSubError1'
const sub_test_f5 : Cion.Lisp<`(- 1 (fn [x] x))`>['ast']['error'] = 'LispSubError0'
const sub_test_f6 : Cion.Lisp<`(- 1 [])`>['ast']['error'] = 'LispSubError0'
const sub_test_f7 : Cion.Lisp<`(- 1 {})`>['ast']['error'] = 'LispSubError0'

const sub_test_f8 : Cion.Lisp<`(- 1 2/3)`> = '1/3'
const sub_test_f : Cion.Lisp<`(- 1 -2/3)`> = '5/3'
